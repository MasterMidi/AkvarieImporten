...
public class FishPackDB implements IFishPackDB {
	...
	@Override
	public Map<Integer, FishPack> getFishPack(String searchInput) throws SQLException {
		...
		while (rs.next()) {
			FishPack fishPack = buildObject(rs);
...
//		System.out.println("PLEASE NOTICE! FishPackDB.getFishPack havent been implemented yet. ");
	...
	private FishPack buildObject(ResultSet rs) throws SQLException {
